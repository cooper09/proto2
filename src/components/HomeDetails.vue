<template>
    <v-container fluid class="blue lighten-4">
        <v-container grid-list-lg>
            <v-layout column>
                <v-flex  class="display-2 font-weight-black gray--text text-xs-center my-5">Instructions</v-flex>
                <v-flex>
                    <div class="headline mt-3 gray--text font-weight-bold">Lorem ipsum</div>
